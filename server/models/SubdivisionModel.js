...
const SubdivisionModel = {
  ...
  getSubdivisionByID: function (id, callback = null) {
    let SQLstmt = SQL_SUB_SELECT + ' and s.id = ?';
  ...
  findSubdivisions: (params) => {
    ...
    let SQLstmt = SQL_SUB_SELECT + findClause + ' order by s.id';
  ...
  save: function (sub, callback = null) {
    ...
    const { id, subdivision, subdivision_name, city_id, created_by, last_updated_by } = sub;
    ...
    const values = [
      id,
      subdivision_name ? subdivision_name : subdivision,
      city_id,
      created_by,
      last_updated_by,
      subdivision_name ? subdivision_name : subdivision,
