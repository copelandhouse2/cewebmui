...
import { DefaultFG, MaterialTabularFG, SimpleSortListView } from './ceFieldGroup';
...
class Client extends Component {
  ...
  handleSave = (updatedRows) => {
    ...
    // console.log('Client handle Save', updatedRows);
  ...
  render() {
    const { currentViews, clientSearch } = this.props;
            ...
            switch (group.name) {
              case 'client_results':
                return(<MaterialTabularFG
                        ...
                        // handleAddEdit={this.handleSave}
                        handleDelete={this.handleDelete}
                        saveHelp='Save the client'
                        editHelp='Edit the client'
                        deleteHelp='Delete the client'
                      />)
                // break;
