...
class scopeSelection extends Component {
  ...
  render() {
    ...
    return (
      <Dialog open={this.props.open} onClose={this.props.toggleScopeDialog} PaperComponent={PaperComponent} aria-labelledby='scope-dialog'>
        ...
        <DialogContent className={classes.content}>
          <Grid container justify='flex-start' alignItems='flex-start' spacing={16}>
            {currentMenu.children &&
              currentMenu.children.map((button) => {
